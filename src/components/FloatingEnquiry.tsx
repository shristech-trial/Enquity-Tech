  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 bottom-4 z-50 w-14 h-14 bg-blue-600 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-blue-700 transition"
        title="Enquiry"
      >
